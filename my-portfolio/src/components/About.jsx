...
export default function About() {
  return (
    <section id="about" className="py-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto text-center">
      ...
      {/* Tombol Download CV */}
      <a
        href="/CV_Safrizal_Rahman.pdf" // Ganti dengan nama file CV kamu
        download="Safrizal_Rahman_CV.pdf" // Nama file saat diunduh
        className="mt-8 inline-flex items-center space-x-2 px-8 py-3 border-2 border-gray-300 rounded-full hover:bg-gray-50 transition group"
      >
